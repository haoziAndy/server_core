...
public:
	...
	bool HttpPostReq(char const* host, char const*port, char const*target, const std::string &content, const std::string &content_type, std::function<void(const std::string&, bool)> callback);
